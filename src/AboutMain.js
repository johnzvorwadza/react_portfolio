...
function AboutMain() {
    return (<div>
        ...
        <p>Throughout my journey as a web developer I've been constantly impressed by how much you can achieve with just a little extra technical knowledge. 
            ...
            but after learning a bit of redux and redux toolkit I realised that there was an easier way of managing states and I have been using that methord since.
            Because of this, my code is now easier to read and it's easier to manage aswell</p>
